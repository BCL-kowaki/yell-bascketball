...
// 北海道の都道府県データ
const hokkaidoPrefectures = [
  {
    id: "hokkaido",
    name: "北海道",
    image: "/placeholder.svg?height=200&width=300&text=北海道",
    featured: true
  }
]
    ...
    <Layout>
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="flex items-center gap-2 mb-6 text-sm">
          ...
          <span className="text-red-600 font-medium">北海道エリア</span>
        </div>
        {/* Header */}
        {/* Statistics */}
        ...
        <div className="mb-12">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900">北海道エリア</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {hokkaidoPrefectures.map((prefecture) => (
              <Link key={prefecture.id} href={`/tournaments/hokkaido/${prefecture.id}`}>
