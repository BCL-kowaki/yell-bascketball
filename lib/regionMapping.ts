...
export const PREFECTURE_SLUG_TO_NAME: Record<string, string> = Object.fromEntries(
  Object.entries(PREFECTURE_NAME_TO_SLUG).map(([name, slug]) => [slug, name])
)
