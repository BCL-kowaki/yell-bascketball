...
export default function PostUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setPdfUrl(cleanValues.pdfUrl);
    setPdfName(cleanValues.pdfName);
    setLocationName(cleanValues.locationName);
    setLocationAddress(cleanValues.locationAddress);
    setLinkUrl(cleanValues.linkUrl);
    setLinkTitle(cleanValues.linkTitle);
    setLinkDescription(cleanValues.linkDescription);
    setLinkImage(cleanValues.linkImage);
    setLikesCount(cleanValues.likesCount);
    setCommentsCount(cleanValues.commentsCount);
